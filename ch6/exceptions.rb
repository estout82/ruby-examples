...
# common errors
# - RuntimeError                default err (call raise)
# - NoMethodError               message receiver does not have that method
...
e.message                               # message for exception
e.full_message                          # full message (very long)
e.backtrace                             # array with stack trace
e.backtrace_location                    # where the exception was thrown
